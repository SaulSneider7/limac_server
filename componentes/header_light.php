    ...
    <div class="container">
        <nav class="js-mega-menu navbar-nav-wrap">
            ...
            <a class="navbar-brand" href="./index.php" aria-label="Front">
                ...
                <sub class="text-primary">&reg;</sub>
            </a>
            <!-- End Default Logo -->
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="hs-has-mega-menu nav-item">
                            <a id="demosMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active"
                                aria-current="page" href="#" role="button">Servicios</a>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="navbar-dropdown-menu-promo">
                                            ...
                                            <div class="navbar-dropdown-menu-promo-item">
                                                <a class="navbar-dropdown-menu-promo-link active"
                                                    href="./traduccion-digital.php">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <span class="navbar-dropdown-menu-media-title">Traducción
                                                                Digital</span>
                                                            <p class="navbar-dropdown-menu-media-desc">Económica, rápida
                                                                y editable</p>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a class="navbar-dropdown-menu-promo-link" href="./traduccion.php">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <span class="navbar-dropdown-menu-media-title">Traducción
                                                                Certificada</span>
                                                            <p class="navbar-dropdown-menu-media-desc">Para todo tipo de
                                                                trámites</p>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a class="navbar-dropdown-menu-promo-link"
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <span class="navbar-dropdown-menu-media-title">Traducción
                                                                Oficial</span>
                                                            <p class="navbar-dropdown-menu-media-desc">Para trámites con
                                                                el MRE</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="navbar-dropdown-menu-promo-item">
                                                <a class="navbar-dropdown-menu-promo-link" href="./interpretacion.php">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <span class="navbar-dropdown-menu-media-title">Interpr.
                                                                Simultánea</span>
                                                            <p class="navbar-dropdown-menu-media-desc">Interpretación en
                                                                tiempo real</p>
                                                        </div>
                                                    </div>
                                                </a>
                                        ...
                                        <div class="navbar-dropdown-menu-promo">
                                            ...
                                            <div class="navbar-dropdown-menu-promo-item">
                                                <a class="navbar-dropdown-menu-promo-link"
                                                    href="./interpretacion-consecutiva.php">
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0">
                                                            <span class="svg-icon svg-icon-sm text-primary">
                                                                <svg width="24" height="24" viewBox="0 0 24 24"
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <span class="navbar-dropdown-menu-media-title">Interpr.
                                                                Consecutiva</span>
                                                            <p class="navbar-dropdown-menu-media-desc">Intérpretes para
                                                                grupos</p>
                                                        </div>
                                                    </div>
                                                </a>
                        ...
                        <!-- Pagos -->
                        <li class="nav-item">
                            <a class="hs-mega-menu-invoker nav-link" href="pagos.php" role="button"
                        ...
                        <!-- Nexus -->
                        <li class="nav-item">
                            <a class="hs-mega-menu-invoker nav-link" href="nexus.php" role="button"
                                aria-expanded="false">Nexus</a>
                        </li>
                        <!-- End Nexus -->

                        <!-- Trabaje aquí -->
                        <li class="nav-item">
                            <a class="hs-mega-menu-invoker nav-link" href="bolsa.php" role="button"
                                aria-expanded="false">Trabaje
                                aquí</a>
                        </li>
                        <!-- End trabaje aqui -->
