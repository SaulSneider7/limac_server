<header id="header" class="navbar navbar-expand-lg navbar-end navbar-absolute-top navbar-dark"
    style="position: fixed; top: 0; left: 0; right: 0; z-index: 1030; transition: transform 0.3s ease;">
    <div class="container">
      <nav class="js-mega-menu navbar-nav-wrap">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <div class="navbar-absolute-top-scroller">
            <ul class="navbar-nav">
              <!-- Demos (reemplaza a Landings) -->
              <li class="hs-has-mega-menu nav-item">
                <a id="demosMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active" aria-current="page"
                  href="#" role="button">Servicios</a>

                <!-- Mega Menu -->
                <div class="hs-mega-menu dropdown-menu w-100 mt-0" aria-labelledby="demosMegaMenu"
                          ...
                          <a class="navbar-dropdown-menu-promo-link active" href="./traduccion-digital.php">
                            <div class="d-flex">
                              ...
                              <div class="flex-grow-1 ms-3">
                                <span class="navbar-dropdown-menu-media-title">Traducción Digital</span>
                                <p class="navbar-dropdown-menu-media-desc">Económica, rápida y editable</p>
                              </div>
                            </div>
                          </a>
                        </div>
                        ...
                        <div class="navbar-dropdown-menu-promo-item">
                          <a class="navbar-dropdown-menu-promo-link" href="./traduccion.php">
                            <div class="d-flex">
                              ...
                              <div class="flex-grow-1 ms-3">
                                <span class="navbar-dropdown-menu-media-title">Traducción Certificada</span>
                                <p class="navbar-dropdown-menu-media-desc">Para todo tipo de trámites</p>
                              </div>
                            </div>
                          </a>
                        </div>
                        ...
                        <div class="navbar-dropdown-menu-promo-item">
                          <a class="navbar-dropdown-menu-promo-link" href="./traduccion-oficial.php">
                            <div class="d-flex">
                              ...
                              <div class="flex-grow-1 ms-3">
                                <span class="navbar-dropdown-menu-media-title">Traducción Oficial</span>
                                <p class="navbar-dropdown-menu-media-desc">Para trámites con el MRE</p>
                              </div>
                            </div>
                          </a>
                        </div>
                        ...
                        <div class="navbar-dropdown-menu-promo-item">
                          <a class="navbar-dropdown-menu-promo-link" href="./interpretacion.php">
                            <div class="d-flex">
                              ...
                              <div class="flex-grow-1 ms-3">
                                <span class="navbar-dropdown-menu-media-title">Interpr. Simultánea</span>
                                <p class="navbar-dropdown-menu-media-desc">Interpretación en tiempo real</p>
                              </div>
                            </div>
                          </a>
                        </div>
                        ...
                        <div class="navbar-dropdown-menu-promo-item">
                          <a class="navbar-dropdown-menu-promo-link" href="./interpretacion-consecutiva.php">
                            <div class="d-flex">
                              ...
                              <div class="flex-grow-1 ms-3">
                                <span class="navbar-dropdown-menu-media-title">Interpr. Consecutiva</span>
                                <p class="navbar-dropdown-menu-media-desc">Intérpretes para grupos</p>
                              </div>
                            </div>
                          </a>
                        </div>
                        ...
                        <div class="navbar-dropdown-menu-promo-item">
                          <a class="navbar-dropdown-menu-promo-link" href="" target="_blank">
                            <div class="d-flex">
                              ...
                              <div class="flex-grow-1 ms-3">
                                <span class="navbar-dropdown-menu-media-title">Interpr. Telefónica</span>
                                <p class="navbar-dropdown-menu-media-desc">Próximamente<i
              ...
              <!-- Resto del menú (Account, Pages, Blog, Portfolio) -->
              <!-- Company -->
              <li class="nav-item border_bottom_whithe">
                <a class="hs-mega-menu-invoker nav-link" href="nosotros.php" role="button"
                  aria-expanded="false">Nosotros</a>
              </li>

              <!-- Portfolio -->
              <li class="nav-item border_bottom_whithe">
                <a class="hs-mega-menu-invoker nav-link" href="pagos.php" role="button" aria-expanded="false">Pagos</a>
              </li>

              <!-- Portfolio -->
              <li class="nav-item border_bottom_whithe">
                <a class="hs-mega-menu-invoker nav-link" href="nexus.php" role="button" aria-expanded="false">Nexus</a>
              </li>

              <!-- Portfolio -->
              <li class="nav-item border_bottom_whithe">
                <a class="hs-mega-menu-invoker nav-link" href="bolsa.php" role="button" aria-expanded="false">Trabaje
                  aquí</a>
              </li>

              <!-- Portfolio -->
              <li class="nav-item border_bottom_whithe">
                <a class="hs-mega-menu-invoker nav-link" href="contacto.php" role="button"
