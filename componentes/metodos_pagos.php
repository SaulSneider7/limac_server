<section class="bg-light py-5">
    <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5">
            <div class="col-lg-8">
                <h2 class="fw-bold mb-3 text-primary">M&eacute;todos de Pago</h2>
                <p class="lead text-muted">
                    Pague de forma rápida y segura con tarjetas de cr&eacute;dito, transferencia bancaria,
                    dep&oacute;sito o en efectivo en
                    nuestras oficinas.
                </p>
            </div>
        </div>
