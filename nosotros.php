...
<head>
    ...
    <!-- Title -->
    <title>Limac | Trabaja con nosotros</title>
    ...
    <main id="content" role="main">
        ...
        <div class="container content-space-t-3 content-space-t-lg-4">
            ...
            <div class="w-lg-65 text-center mx-lg-auto mb-5 mb-md-9">
                <h1 class="text-primary">Nuestros traductores, nuestro orgullo</h1>
            </div>
            <!-- End Heading -->
        ...
        <div class="container content-space-2 content-space-lg-3">
            ...
            <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
                <span class="text-cap">Quienes somos</span>
                <h2 class="text-primary">Desde 2013, hemos ayudado a miles de personas a alcanzar nuevos horizontes</h2>
            </div>
            <!-- End Heading -->
            ...
            <div class="row justify-content-lg-center">
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    ...
                    <div class="d-flex pe-md-5">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p>Consolidarnos como empresa líder de servicios de traducción de alta calidad en Perú.</p>
                        </div>
                    </div>
                    <!-- End Icon Blocks -->
                </div>
                ...
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    ...
                    <div class="d-flex ps-md-5">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h4>Compartimos nuestros valores</h4>
                            <p>Como líderes contagiamos la excelencia e innovación a los que están en nuestro etorno.
                            </p>
                        </div>
                    </div>
                    <!-- End Icon Blocks -->
                ...
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    ...
                    <div class="d-flex pe-md-5">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h4>Nuestro secreto</h4>
                            <p>Solamente trabajamos con traductores certificados que avalan su calidad.</p>
                        </div>
                    </div>
                    <!-- End Icon Blocks -->
                </div>
                ...
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    ...
                    <div class="d-flex ps-md-5">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h4>Visión hacia el futuro</h4>
                            <p>Apertura de nuestra primera sede europea en Madrid, España proyectada para 2025</p>
                        </div>
                    </div>
                    <!-- End Icon Blocks -->
                </div>
                ...
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-0">
                    ...
                    <div class="d-flex pe-md-5">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p>Integrar a nuestro equipo a los mejores traductores e intérpretes a nivel internacional.
                            </p>
                        </div>
                    </div>
                    <!-- End Icon Blocks -->
                ...
                <div class="col-md-6 col-lg-5">
                    ...
                    <div class="d-flex ps-md-5">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h4>Lo hacemos con ♥</h4>
                            <p>Nuestra pasión son los idiomas y amamos tener el privilegio de traducirlos.</p>
                        </div>
                    </div>
                    <!-- End Icon Blocks -->
                </div>
                        ...
                        <ul class="nav nav-lg nav-pills nav-pills-shadow flex-lg-column gap-lg-1 p-3" id="featuresTab"
                                ...
                                <a class="nav-link active" href="#featuresOne" id="featuresOne-tab" data-bs-toggle="tab"
                                    ...
                                    <div class="d-flex align-items-center align-items-lg-start">
                                        <span class="svg-icon svg-icon-sm text-primary" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="gra/gra004.svg">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h4 class="mb-1">Visión</h4>
                                            <p class="text-body text-wrap mb-0">Consolidarnos como empresa líder en
                                                Perú, y ser el proveedor
                                                preferido de productos y servicios de alta calidad.</p>
                                        </div>
                                    </div>
                                    <!-- End Media -->
                                </a>
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" href="#featuresTwo" id="featuresTwo-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false" style="min-width: 20rem;">
                                    <!-- Media -->
                                    <div class="d-flex align-items-center align-items-lg-start">
                                        <span class="svg-icon svg-icon-sm text-primary" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="gen/gen002.svg">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h4 class="mb-1">Misión</h4>
                                            <p class="text-body text-wrap mb-0">Contribuir a la productividad de
                                                nuestros clientes ofreciendo
                                                productos y servicios innovadores, competitivos, y rentables.</p>
                                        </div>
                                    </div>
                                    <!-- End Media -->
                                </a>
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" href="#featuresThree" id="featuresThree-tab" data-bs-toggle="tab"
                                    data-bs-target="#featuresThree" role="tab" aria-controls="featuresThree"
                                    aria-selected="false" style="min-width: 20rem;">
                                    <!-- Media -->
                                    <div class="d-flex align-items-center align-items-lg-start">
                                        <span class="svg-icon svg-icon-sm text-primary" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="gen/gen020.svg">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M14 18V16H10V18L9 20H15L14 18Z" fill="#035A4B" />
                                                <path opacity="0.3"
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="text-body text-wrap mb-0">Profesionalismo, transparencia,
        ...
        <!-- End Mision, vision y valores -->

        <!-- Clients -->
        <div class="container content-space-2 content-space-b-lg-3">
            <!-- Heading -->
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h2 class="fw-bold text-primary">Empresas que confían en Limac</h2>
                <p class="text-muted">Más de una década brindando servicios de traducción a compañías líderes del sector
                    público
                    y privado.</p>
            </div>
            <!-- End Heading -->
